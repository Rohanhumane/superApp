...
const s = StyleSheet.create({
  box: { flexDirection: 'row', alignItems: 'center', borderWidth: 1, borderColor: colors.border.light, borderRadius: br.md, backgroundColor: colors.bg.input, paddingHorizontal: sp.lg, paddingVertical: sp.md + 2 },
  list: { borderWidth: 1, borderColor: colors.border.light, borderRadius: br.md, backgroundColor: colors.white, marginTop: 4, elevation: 3, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.1, shadowRadius: 4 },
  item: { paddingHorizontal: sp.lg, paddingVertical: sp.md },
});
